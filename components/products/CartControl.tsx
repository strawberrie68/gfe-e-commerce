...
const CartControl = () => {
    ...
    return (
        <fieldset className="flex flex-col items-start gap-4">
            ...
            <div className="w-[125px] h-9 flex justify-center items-center text-neutral-600 gap-3 bg-neutral-50 p-0.5 rounded-md border border-solid border-neutral-200">
                <button
                    type="button"
                    onClick={decrementQuantity}
                    disabled={isDecrementDisabled}
                    className="basis-4 min-w-11 min-h-11 flex justify-center items-center disabled:cursor-not-allowed">
                    <Minus size={12} color={isDecrementDisabled ? "#a3a3a3" : "#525252"} />
                </button>
                <span className="flex-grow">{itemQuantity}</span>
